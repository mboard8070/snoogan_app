...
# Fixed: Robust column detection for bid/ask to prevent KeyError
import os
import json
import pandas as pd
...
class TradingStrategy:
    ...
    def _attempt_entry(self, ticker, trend, chain, price):
        ...
        if not candidates:
            print(f" [{ticker}] No valid strike-based spreads with credit >= $0.20 – skipping entry")
            return
